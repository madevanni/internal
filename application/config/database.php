...
if (defined('CI_VERSION') && substr(CI_VERSION, 0, 1) != '2') {
    ...
    $db['stockTake']['hostname'] = 'localhost';
    $db['stockTake']['username'] = 'root';
    $db['stockTake']['password'] = '';
    $db['stockTake']['database'] = 'bf_sto';
    $db['stockTake']['port'] = '';
    $db['stockTake']['dbdriver'] = 'bfmysqli';
    $db['stockTake']['dbprefix'] = 'bf_';
    $db['stockTake']['pconnect'] = true;
    $db['stockTake']['db_debug'] = true;
    $db['stockTake']['cache_on'] = false;
    $db['stockTake']['cachedir'] = '';
    $db['stockTake']['char_set'] = 'utf8';
    $db['stockTake']['dbcollat'] = 'utf8_general_ci';
    $db['stockTake']['swap_pre'] = '';
    $db['stockTake']['autoinit'] = true;
    $db['stockTake']['stricton'] = true;
}
