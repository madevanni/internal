...
{
    protected $permissionCreate = 'Planning.Reports.Create';
    protected $permissionDelete = 'Planning.Reports.Delete';
    protected $permissionEdit   = 'Planning.Reports.Edit';
    protected $permissionView   = 'Planning.Reports.View';
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            ...
            redirect(SITE_AREA . '/reports/planning');
        }
