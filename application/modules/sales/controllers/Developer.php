...
{
    protected $permissionCreate = 'Sales.Developer.Create';
    protected $permissionDelete = 'Sales.Developer.Delete';
    protected $permissionEdit   = 'Sales.Developer.Edit';
    protected $permissionView   = 'Sales.Developer.View';
    ...
    public function edit()
    {
        ...
        if (empty($id)) {
            ...
            redirect(SITE_AREA . '/developer/sales');
        }
