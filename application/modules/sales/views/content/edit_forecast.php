...
<div class='admin-box'>
    ...
    <fieldset>
        ...
        <div class="control-group<?php echo form_error('fy') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='fy' type='text' required='required' name='fy' maxlength='4' value="<?php echo set_value('fy', isset($forecast->fy) ? $forecast->fy : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_one') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_one' type='text' name='p_one' maxlength='11' value="<?php echo set_value('p_one', isset($forecast->p_one) ? $forecast->p_one : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_two') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_two' type='text' name='p_two' maxlength='11' value="<?php echo set_value('p_two', isset($forecast->p_two) ? $forecast->p_two : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_three') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_three' type='text' name='p_three' maxlength='11' value="<?php echo set_value('p_three', isset($forecast->p_three) ? $forecast->p_three : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_four') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_four' type='text' name='p_four' maxlength='11' value="<?php echo set_value('p_four', isset($forecast->p_four) ? $forecast->p_four : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_five') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_five' type='text' name='p_five' value="<?php echo set_value('p_five', isset($forecast->p_five) ? $forecast->p_five : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_six') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_six' type='text' name='p_six' value="<?php echo set_value('p_six', isset($forecast->p_six) ? $forecast->p_six : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_seven') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_seven' type='text' name='p_seven' value="<?php echo set_value('p_seven', isset($forecast->p_seven) ? $forecast->p_seven : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_eight') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_eight' type='text' name='p_eight' value="<?php echo set_value('p_eight', isset($forecast->p_eight) ? $forecast->p_eight : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_nine') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_nine' type='text' name='p_nine' value="<?php echo set_value('p_nine', isset($forecast->p_nine) ? $forecast->p_nine : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_ten') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_ten' type='text' name='p_ten' value="<?php echo set_value('p_ten', isset($forecast->p_ten) ? $forecast->p_ten : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_eleven') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_eleven' type='text' name='p_eleven' value="<?php echo set_value('p_eleven', isset($forecast->p_eleven) ? $forecast->p_eleven : ''); ?>" />
        ...
        <div class="control-group<?php echo form_error('p_twelve') ? ' error' : ''; ?>">
            ...
            <div class='controls'>
                <input id='p_twelve' type='text' name='p_twelve' value="<?php echo set_value('p_twelve', isset($forecast->p_twelve) ? $forecast->p_twelve : ''); ?>" />
