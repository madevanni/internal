...
<ul class="nav nav-pills">
	...
	<li <?php echo $this->uri->segment(4) == 'forecast' ? 'class="active"' : '' ?>>
        ...
        <li <?php echo $this->uri->segment(4) == 'orders' ? 'class="active"' : '' ?>>
		<a href="<?php echo site_url(SITE_AREA .'/content/sales/orders') ?>" id="orders">Orders</a>
	</li>
        <li <?php echo $this->uri->segment(4) == 'projects' ? 'class="active"' : '' ?>>
		<a href="<?php echo site_url(SITE_AREA .'/content/sales/projects') ?>" id="orders">Projects</a>
	</li>
</ul>
<?php endif;?>